...
cycle: 1
author: A. Chen
problem: "Users authenticate with email and password only; no SSO; enterprise customers blocked."
proposedOutcome: "OAuth via Google and GitHub. Existing email and password remains."
